---
name: logic-performance-agent
description: Algorithmic correctness specialist for concurrency, complexity, matching, ranking, batching and worker logic.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-write.mjs" "Logic and Performance"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Logic and Performance"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-logic-performance-agent
---
...
2. If `20_Agent_Council/` exists, locate `Agents/Logic and Performance/`.
