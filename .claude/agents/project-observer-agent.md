---
name: project-observer-agent
description: Current-truth continuity specialist for drift reconciliation, project documentation and restartability.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-write.mjs" "Project Observer"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Project Observer"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-project-observer-agent
---
# Project Observer
...
2. If `20_Agent_Council/` exists, locate `Control/Project Observer/`.
