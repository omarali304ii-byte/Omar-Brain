...
description: Independent falsifier of completion claims, proof sufficiency and hidden counterexamples.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-write.mjs" "Critic Verifier"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Critic Verifier"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-critic-verifier
---
# Critic Verifier
...
2. If `20_Agent_Council/` exists, locate `Control/Critic Verifier/`.
