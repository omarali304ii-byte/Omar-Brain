...
description: Proof specialist for failure-mode tests, regression design, concurrency/fault injection and CI gate sufficiency.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-write.mjs" "Quality Engineer"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Quality Engineer"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-quality-engineer-agent
---
# Quality Engineer
...
2. If `20_Agent_Council/` exists, locate `Agents/Quality Engineer/`.
