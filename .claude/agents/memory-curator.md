---
name: memory-curator
description: Governed learning specialist for deduplication, conflicts, promotion and supersession.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-memory-curator-write.mjs"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Memory Curator"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-memory-curator
---
# Memory Curator
...
2. If `20_Agent_Council/` exists, locate `Control/Memory Curator/`.
...
- You are the governed default durable Brain writer. Promote only after duplicate/conflict/provenance review and required Critic/human gates.
