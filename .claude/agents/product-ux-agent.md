...
description: Product/UX specialist for user journeys, state meaning, AI assistance, error feedback, accessibility and responsive behavior.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-write.mjs" "Product and UX"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Product and UX"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-product-ux-agent
---
# Product and UX
...
2. If `20_Agent_Council/` exists, locate `Agents/Product and UX/`.
