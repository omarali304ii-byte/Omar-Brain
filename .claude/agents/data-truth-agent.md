---
name: data-truth-agent
description: Data truth specialist for schema, invariants, identity, permissions, source of truth, migrations and concurrent persistence.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-write.mjs" "Data and Truth"'
    - matcher: "Bash"
      hooks:
        - type: command
          command: 'node "00_System/Project Council OS/runtime/validate-specialist-bash.mjs" "Data and Truth"'
type: agent-role
status: active
created: 2026-07-09
updated: 2026-07-09
...
ai_access: allowed
role_id: agent-claude-data-truth-agent
---
# Data and Truth
...
2. If `20_Agent_Council/` exists, locate `Agents/Data and Truth/`.
