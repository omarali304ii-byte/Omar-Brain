...
- [ ] Activation check: new module/service boundary.
- [ ] Activation check: route gains business orchestration.
- [ ] Activation check: schema change changes ownership.
- [ ] Activation check: sync/async boundary changes.
