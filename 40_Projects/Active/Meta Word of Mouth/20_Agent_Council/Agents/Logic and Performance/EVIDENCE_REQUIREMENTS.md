# Logic and Performance Evidence Requirements

Closure requires concurrent jobs against the same person and proof that newer semantic state is not overwritten by older jobs.
