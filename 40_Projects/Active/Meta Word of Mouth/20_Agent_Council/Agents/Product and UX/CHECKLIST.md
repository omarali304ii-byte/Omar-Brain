...
- [ ] Activation check: user-visible state machine changes.
- [ ] Activation check: new AI assistance flow.
- [ ] Activation check: send/retry behavior changes.
- [ ] Activation check: sensitive identifier display.
