# Integration and Workflow Evidence Requirements

Integration closure requires tests for accepted-provider/local-failure, retries, stale locks, and duplicate/idempotent workflows.
